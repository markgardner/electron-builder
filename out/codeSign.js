...
function findIdentity(namePrefix, qualifier) {
    return __awaiter(this, void 0, void 0, function* () {
        if (exports.findIdentityRawResult == null) {
            ...
            exports.findIdentityRawResult = util_1.exec("security", ["find-identity", "-v", "-p", "codesigning", "-p", "appleID"]);
        }
        // https://github.com/electron-userland/electron-builder/issues/484
        const lines = (yield exports.findIdentityRawResult).trim().split("\n").filter(it => !(it.indexOf("(Missing required extension)") !== -1) && !(it.indexOf("valid identities found") !== -1) && !(it.indexOf("iPhone ") !== -1));
