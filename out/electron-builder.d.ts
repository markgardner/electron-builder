declare module 'electron-builder/out/asarUtil' {
  ...
  export function createAsarArchive(src: string, resourcesPath: string, options: AsarOptions): Promise<any>

  export function checkFileInPackage(asarFile: string, relativeFile: string): Promise<void>
}
...
declare module 'electron-builder/out/builder' {
  ...
  export function createPublisher(packager: Packager, options: PublishOptions, repoSlug: InfoRetriever, isPublishOptionGuessed?: boolean): Promise<Publisher | null>
...
declare module 'electron-builder/out/gitHubPublisher' {
  ...
  export class GitHubPublisher implements Publisher {
    ...
    constructor(owner: string, repo: string, version: string, options: PublishOptions, policy?: string)
...
declare module 'electron-builder' {
  ...
  export { AppMetadata, DevMetadata, Platform, Arch, archFromString, getProductName, BuildMetadata, OsXBuildOptions, WinBuildOptions, LinuxBuildOptions, CompressionLevel } from "electron-builder/out/metadata"
}
...
declare module 'electron-builder/out/linuxPackager' {
  ...
  export class LinuxPackager extends PlatformPackager<LinuxBuildOptions> {
    ...
    readonly supportedTargets: Array<string>
...
declare module 'electron-builder/out/platformPackager' {
  ...
  export abstract class PlatformPackager<DC extends PlatformSpecificBuildOptions> implements ProjectMetadataProvider {
    ...
    readonly abstract supportedTargets: Array<string>
...
declare module 'electron-builder/out/targets/archive' {
  ...
  export function archiveApp(compression: CompressionLevel | n, format: string, outFile: string, dirToArchive: string): Promise<any>
}

declare module 'electron-builder/out/targets/squirrelWindows' {
  import { WinPackager } from "electron-builder/out/winPackager"
  import { ElectronPackagerOptions } from "electron-packager-tf"
  import { Arch, WinBuildOptions } from "electron-builder/out/metadata"

  export default class SquirrelWindowsTarget {
    constructor(packager: WinPackager, appOutDir: string, arch: Arch)
    build(packOptions: ElectronPackagerOptions): Promise<void>
    computeEffectiveDistOptions(installerOutDir: string, packOptions: ElectronPackagerOptions, setupExeName: string): Promise<WinBuildOptions>
  }
}
