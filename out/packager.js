...
class Packager {
    ...
    build() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.metadata = appPackageFile === devPackageFile ? this.options.appMetadata || this.devMetadata : deepAssign((yield util_1.readPackageJson(appPackageFile)), this.options.appMetadata);
