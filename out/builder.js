...
function createPublisher(packager, options, repoSlug) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (info == null) {
            ...
            return new gitHubPublisher_1.GitHubPublisher(info.user, info.project, packager.metadata.version, options, options.publish);
        }
    });
}
    ...
    function processTargets(platform, types) {
        ...
        if (types.length === 0) {
            if (platform === metadata_1.Platform.OSX) {
                archToType.set(metadata_1.Arch.x64, []);
            } else {
